...
os.chdir('/Users/xxx/magphys_highz/output_highz')

# Input user files
flux_file = '/Users/xxx/magphys_highz/user_files/observations.dat'
filter_file = '/Users/xxx/magphys_highz/user_files/filters.dat'
...
# Read in the PDFs
    ...
    Ldust_pdf = np.loadtxt(source+'.fit',skiprows=394,max_rows=70)
    Mdust_pdf = np.loadtxt(source+'.fit',skiprows=688,max_rows=60)
    age_M_pdf = np.loadtxt(source+'.fit',skiprows=814,max_rows=50)
    AV_pdf = np.loadtxt(source+'.fit',skiprows=1073,max_rows=80)
    tau_V_ISM_pdf = np.loadtxt(source+'.fit',skiprows=605,max_rows=80)
    mu_pdf = np.loadtxt(source+'.fit',skiprows=62,max_rows=20)
    Tdust_pdf = np.loadtxt(source+'.fit',skiprows=1156,max_rows=14)
...
# Read in the percentiles
    ...
    Ldust_percentile = np.loadtxt(source+'.fit',skiprows=465,max_rows=1)
    Mdust_percentile = np.loadtxt(source+'.fit',skiprows=749,max_rows=1)
    age_M_percentile = np.loadtxt(source+'.fit',skiprows=865,max_rows=1)
    AV_percentile = np.loadtxt(source+'.fit',skiprows=1154,max_rows=1)
    tau_V_ISM_percentile = np.loadtxt(source+'.fit',skiprows=686,max_rows=1)
    mu_percentile = np.loadtxt(source+'.fit',skiprows=83,max_rows=1)
    Tdust_percentile = np.loadtxt(source+'.fit',skiprows=1171,max_rows=1)
